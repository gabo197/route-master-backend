...
namespace RouteMaster.API.Migrations
{
    ...
    [Migration("20231117053108_AddRatingEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.PassengerFavoriteBusLine", b =>
                {
                    ...
                    b.HasKey("BusLineId", "PassengerId");

                    b.HasIndex("PassengerId");

                    b.ToTable("PassengerFavoriteBusLine", (string)null);
                });
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.Rating", b =>
                {
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.BusLineStop", b =>
                {
                    ...
                    b.Property<int>("BusLineLineId")
                        .HasColumnType("int");

                    b.Property<int>("BusStopStopId")
                        .HasColumnType("int");

                    b.HasIndex("BusLineLineId");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.RailwayLineStop", b =>
                {
                    ...
                    b.Property<int>("RailwayLineLineId")
                        .HasColumnType("int");

                    b.Property<int>("RailwayStopStopId")
                        .HasColumnType("int");

                    b.HasIndex("RailwayLineLineId");

                    b.HasIndex("RailwayStopStopId");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.SubwayLineStop", b =>
                {
                    ...
                    b.Property<int>("SubwayLineLineId")
                        .HasColumnType("int");

                    b.Property<int>("SubwayStopStopId")
                        .HasColumnType("int");

                    b.HasIndex("SubwayLineLineId");

                    b.HasIndex("SubwayStopStopId");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.BusTripDetail", b =>
                {
                    b.HasBaseType("RouteMaster.API.Domain.Models.TripDetail");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.RailwayTripDetail", b =>
                {
                    b.HasBaseType("RouteMaster.API.Domain.Models.TripDetail");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.SubwayTripDetail", b =>
                {
                    b.HasBaseType("RouteMaster.API.Domain.Models.TripDetail");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.PassengerFavoriteBusLine", b =>
                {
                    b.HasOne("RouteMaster.API.Domain.Models.BusLine", "BusLine")
                        .WithMany("PassengerFavoriteBusLines")
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.Rating", b =>
                {
                    ...
                    b.HasOne("RouteMaster.API.Domain.Models.BusTripDetail", "BusTripDetail")
                        .WithOne("Rating")
                        .HasForeignKey("RouteMaster.API.Domain.Models.Rating", "TripDetailId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("BusTripDetail");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.BusDriver", b =>
                {
                    b.HasOne("RouteMaster.API.Domain.Models.Bus", "Bus")
                        .WithOne("BusDriver")
                        .HasForeignKey("RouteMaster.API.Domain.Models.BusDriver", "VehicleId");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.RailwayDriver", b =>
                {
                    b.HasOne("RouteMaster.API.Domain.Models.Railway", "Railway")
                        .WithOne("RailwayDriver")
                        .HasForeignKey("RouteMaster.API.Domain.Models.RailwayDriver", "VehicleId");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.SubwayDriver", b =>
                {
                    b.HasOne("RouteMaster.API.Domain.Models.Subway", "Subway")
                        .WithOne("SubwayDriver")
                        .HasForeignKey("RouteMaster.API.Domain.Models.SubwayDriver", "VehicleId");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.RailwayLineStop", b =>
                {
                    b.HasOne("RouteMaster.API.Domain.Models.RailwayLine", "RailwayLine")
                        .WithMany("RailwayLineStops")
                        .HasForeignKey("RailwayLineLineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RouteMaster.API.Domain.Models.RailwayStop", "RailwayStop")
                        .WithMany("RailwayLineStops")
                        .HasForeignKey("RailwayStopStopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RailwayLine");

                    b.Navigation("RailwayStop");
                });

            modelBuilder.Entity("RouteMaster.API.Domain.Models.SubwayLineStop", b =>
                {
                    b.HasOne("RouteMaster.API.Domain.Models.SubwayLine", "SubwayLine")
                        .WithMany("SubwayLineStops")
                        .HasForeignKey("SubwayLineLineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RouteMaster.API.Domain.Models.SubwayStop", "SubwayStop")
                        .WithMany("SubwayLineStops")
                        .HasForeignKey("SubwayStopStopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SubwayLine");

                    b.Navigation("SubwayStop");
                });
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.RailwayTripDetail", b =>
                {
                    b.HasOne("RouteMaster.API.Domain.Models.RailwayStop", "DestinationRailwayStop")
                        .WithMany()
                        .HasForeignKey("DestinationStopId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("RouteMaster.API.Domain.Models.RailwayStop", "OriginRailwayStop")
                        .WithMany()
                        .HasForeignKey("OriginStopId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("DestinationRailwayStop");

                    b.Navigation("OriginRailwayStop");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.SubwayTripDetail", b =>
                {
                    b.HasOne("RouteMaster.API.Domain.Models.SubwayStop", "DestinationSubwayStop")
                        .WithMany()
                        .HasForeignKey("DestinationStopId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.HasOne("RouteMaster.API.Domain.Models.SubwayStop", "OriginSubwayStop")
                        .WithMany()
                        .HasForeignKey("OriginStopId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("DestinationSubwayStop");

                    b.Navigation("OriginSubwayStop");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.Trip", b =>
                {
                    b.Navigation("BusTripDetails");

                    b.Navigation("RailwayTripDetails");

                    b.Navigation("SubwayTripDetails");
                });
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.Passenger", b =>
                {
                    ...
                    b.Navigation("PassengerFavoriteBusLines");
            ...
            modelBuilder.Entity("RouteMaster.API.Domain.Models.Railway", b =>
                {
                    b.Navigation("RailwayDriver");
                });

            modelBuilder.Entity("RouteMaster.API.Domain.Models.Subway", b =>
                {
                    b.Navigation("SubwayDriver");
                });
